...
class SensorHelper(private val context: Context) {
    ...
    fun getFlatUpSensor(): Sensor =
        sensorManager.getDefaultSensor(SENSOR_TYPE_MMI_FLAT_UP, true)!!

    fun getFlatDownSensor(): Sensor =
        sensorManager.getDefaultSensor(SENSOR_TYPE_MMI_FLAT_DOWN, true)!!

    fun getProximitySensor(): Sensor =
        sensorManager.getDefaultSensor(Sensor.TYPE_PROXIMITY, true)!!

    fun getStowSensor(): Sensor =
        sensorManager.getDefaultSensor(SENSOR_TYPE_MMI_STOW, true)!!
