...
class LiftToSilence(
    ...
    private val flatUpListener = object : SensorEventListener {
        @Synchronized
        override fun onSensorChanged(event: SensorEvent) {
            ...
            Log.d(
                TAG,
                "event: $thisFlatUp mLastFlatUp=$lastFlatUp mIsStowed=$isStowed"
            )
    ...
    private val stowListener = object : SensorEventListener {
        @Synchronized
        override fun onSensorChanged(event: SensorEvent) {
