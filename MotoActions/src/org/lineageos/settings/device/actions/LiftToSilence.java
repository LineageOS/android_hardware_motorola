...
public class LiftToSilence extends PhoneStateListener
        implements SensorEventListener, UpdatedStateNotifier {
    ...
    public synchronized void onSensorChanged(SensorEvent event) {
        ...
        Log.d(
                TAG,
                "event: " + thisFlatUp + " mLastFlatUp=" + mLastFlatUp + " mIsStowed=" + mIsStowed);
