...
public class MotoActionsSettings {
    ...
    public static boolean isAlwaysOnEnabled(Context context) {
        return Settings.Secure.getIntForUser(
                        context.getContentResolver(), DOZE_ALWAYS_ON, 0, UserHandle.USER_CURRENT)
                != 0;
    }
            ...
            new SharedPreferences.OnSharedPreferenceChangeListener() {
                ...
                public void onSharedPreferenceChanged(SharedPreferences sharedPrefs, String key) {
                    ...
                    if (GESTURE_CAMERA_ACTION_KEY.equals(key)) {
                        mCameraGestureEnabled =
                                sharedPrefs.getBoolean(GESTURE_CAMERA_ACTION_KEY, true);
