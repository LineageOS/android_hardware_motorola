...
class DozePreferenceFragment : SettingsBasePreferenceFragment(),
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        val switchBar: MainSwitchPreference =
            findPreference(MotoActionsSettings.DOZE_ENABLE)!!
        switchBar.onPreferenceChangeListener = this
        switchBar.isChecked = dozeEnabled

        alwaysOnDisplayPreference =
            findPreference(MotoActionsSettings.ALWAYS_ON_DISPLAY)!!
        ...
        if (!MotoActionsSettings.alwaysOnDisplayAvailable(requireActivity())) {
            ...
            val ambientDisplayCategory: PreferenceCategory =
                findPreference("ambient_display_key")!!
            ambientDisplayCategory.dependency =
